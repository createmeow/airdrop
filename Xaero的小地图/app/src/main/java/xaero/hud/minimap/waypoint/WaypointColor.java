...
/* loaded from: [Xaero的小地图] xaerominimap-neoforge-1.21.1-25.3.10.jar:xaero/hud/minimap/waypoint/WaypointColor.class */
public enum WaypointColor {
    ...
    WaypointColor(Component name, char format, int hex) {
        this.name = name;
        this.format = format;
        this.hex = hex;
    }
